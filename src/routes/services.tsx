...
const services: {
  ...
  },
  {
    ...
    intro: "ويختص بالآتي:",
    items: [
      "إجراء البحوث والدراسات المتعلقة بالجريمة والعقاب بالتنسيق مع الجهات المختصة.",
      "تقديم الاقتراحات المتعلقة بالوسائل الكفيلة للقضاء على الجريمة وتطوير نظم العقاب.",
      "التعاون مع الجهات ذات الاختصاص في البحوث القانونية والقضائية بشأن إعداد البحوث والدراسات التي من شأنها تطوير النظم القانونية والقضائية المعمول بها.",
      "جمع البيانات والمعلومات والإحصائيات اللازمة لإجراء البحوث والدراسات.",
      "إعداد البحوث الاجتماعية التي تطلبها الجهات القضائية وعلى الأخص فيما يتعلق بقضايا الأحداث وقضايا الأحوال الشخصية.",
      "دراسة الظواهر الإجرامية وأسلوب تطور الجريمة وإعداد المقترحات اللازمة لمكافحتها بالوسائل العلمية المتطورة والحد من انتشارها.",
      "تجميع وحفظ البحوث والدراسات المتعلقة بالجريمة والعقاب لإمكانية الاستفادة منها كدراسات سابقة.",
      "اقتراح مشاريع البحوث والدراسات العلمية التي تحقق أهداف المركز.",
      "متابعة ما يصدر عن الندوات واللقاءات العلمية والاجتماعات المحلية والدولية والتي تعقد في مجالات الجريمة والعقاب والعمل على المشاركة فيها.",
      "تحديد احتياجات التدريب والتأهيل وإعادة التأهيل واقتراح الخطط والبرامج التدريبية التي من شأنها تطوير مستوى أداء العاملين بالمركز.",
      "الإشراف على عملية التدريب من خلال التنسيق مع المؤسسات التدريبية في الداخل والخارج ومتابعة تنفيذها مع الجهات ذات العلاقة وإعداد تقارير دورية بشأنها، واقتراح المجالات التي يمكن أن يستفاد منها في تنمية وتطوير الموارد البشرية.",
      "جمع ومتابعة الاتفاقيات الدولية والنشرات العلمية ذات العلاقة.",
      "الإشراف على المكتبة من حيث تنظيم إعارة مراجعها، ومتابعة تغذيتها بالمراجع العلمية وكافة مصادر المعرفة والمعلومات التي تخدم أهداف المركز.",
      "أي أعمال أخرى تسند للمكتب بما يتماشى واختصاصاته.",
    ],
  },
];
  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="يقدم المركز مجموعةً شاملةً من خدمات الخبرة القضائية والتحاليل والتقارير، بكوادرَ مؤهلةٍ ومختبراتٍ حديثة."
        image={servicesHero}
      />
